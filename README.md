...
- **Course:** FA25-CSE-40693-01 Modern Web Development  
- **Authors:** Phoebe Huang & Mirella Wunderlich  
...
This copies configuration files (Webpack, Babel, ESLint, etc.) into your project for full customization.
...
To deploy your app, follow [Create React App’s deployment guide](https://facebook.github.io/create-react-app/docs/deployment).  
Your app will be built into the `/build` directory and ready for production.
